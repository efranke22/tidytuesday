...
plot2 <- paralympic_swimming %>%
  ...
  ggplot(aes(x = fct_relevel(abb, levels = c("GBR", "USA", "AUS", "ESP", "CAN")), y=number, fill = medal))+
  geom_col()+
  theme_minimal()+
  scale_fill_manual(values = c("#D89581", "#D4AF37", "#C0C0C0"))+
  scale_x_discrete(expand = c(0,0)) +
  labs(x="", y="", fill = "", title = "Medals for top 5 paralympic swimming countries")+
...
plot1 <- athletes %>%
  ...
  theme_minimal()+
  labs(x="", y="", title = "Unique countries winning a gold swimming medal")+
